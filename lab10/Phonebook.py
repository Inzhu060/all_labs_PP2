...
while check:
    if start == True or back == True:
        ...
        3. Type "q" or "Q" in order to male specific QUERY in the table.
        ...
        if command == "d" or command == "D":
            ...
            conn.commit()
            back_com = str(input('Type "back" in order to return to the list of the commans: '))
            if back_com == "back":
                back = True
        ...
        if command == "q" or command == "Q":
            ...
            if temp == "id":
                ...
                back_com = str(input('Type "back" in order to return to thelist of the commands: '))
                if back_com == "back":
                    back = True 
